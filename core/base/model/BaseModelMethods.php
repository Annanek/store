...
abstract class BaseModelMethods
{
    ...
    protected function createFields($set, $table = false) {
        ...
        //todo: $table = ($table && !$set['no_concat']) ? $table . '.' : '';
    ...
    protected function createOrder($set, $table = false) {
        ...
        // todo: if (is_array($set['order']) && !empty($set['order']))
    ...
    protected function createWhere($set, $table = false, $instruction = 'WHERE') {
        ...
        if (!empty($set['where']) && is_array($set['where'])) {
            ...
            //todo: $set['condition'] = (is_array($set['condition']) && !empty($set['condition'])) ? $set['condition'] : ['AND'];
            ...
            foreach ($set['join'] as $key => $item) {
                ...
                if ($item['on']) {
                    ...
                    switch (2) {
                        ...
                        //todo: l23 код в комментариях // case count($item['on']['fields'])
